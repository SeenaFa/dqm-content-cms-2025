...
if __name__ == '__main__':
    expected_file = "./scripts/comparison/qicore_actual_results.csv"
    actual_file = "./scripts/comparison/quality_actual_results.csv"
    output_file = "./scripts/comparison/quality_output_results.csv"
    comparison_report = "./scripts/comparison/quality_discrepancy_report.md"
